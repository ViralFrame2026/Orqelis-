...
export const alt = "ORQELIS — Casa, bazar y regalos";
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", width: 760 }}>
        ...
        <div style={{ display: "flex", marginTop: 42, maxWidth: 760, fontSize: 72, lineHeight: 1.04, fontWeight: 800 }}>Objetos que hacen hogar.</div>
        <div style={{ display: "flex", marginTop: 30, fontSize: 27, color: "#f0c9ad", letterSpacing: 1 }}>Casa · Bazar · Regalos · Tecnología</div>
      </div>
    </div>,
    size,
  );
